...
//                
//                ForEach(dataManager.carv2RawDataPair.right.forDebug.indices, id: \.self) { i in
//                    Grid {
//                        Text("\(i.ｓdescription)  \(dataManager.carv2RawDataPair.right.forDebug[i].formatted(FloatingPointFormatStyle<Float>.number.precision(.fractionLength(1))))")
//                    }
//                }
//            }
//        }
