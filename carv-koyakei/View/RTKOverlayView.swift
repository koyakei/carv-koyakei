...
//                                .padding(.bottom, 10)
            ...
            latoLongToARKit.originalPoint = RTKDevise.shared.currentData
        }
    }
    
    @State  var latoLongToARKit: LatLongToARKit = LatLongToARKit(originalPoint: CLLocation.init())
...
#Preview {
    RTKOverlayView(latoLongToARKit: LatLongToARKit(originalPoint: CLLocation.init()))
}
