...
//    static let leftCharactaristicUUID = UUID(uuidString:  "850D8BCF-3B03-1322-F51C-DD38E961FC1A")
    // iphone
    let rightCharactaristicUUID = UUID(uuidString:"3A2C0B9A-44CF-2093-9B3C-F511045910D1")
    let leftCharactaristicUUID = UUID(uuidString: "3F6F19CB-0226-506F-6C93-76120A65FD5D")
